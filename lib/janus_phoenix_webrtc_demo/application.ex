defmodule JanusPhoenixWebrtcDemo.Application do
  use Application
  ...
  def start(_type, _args) do
    ...
    children = [
      ...
      supervisor(JanusPhoenixWebrtcDemo.Repo, []),
      ...
      supervisor(ConCache, [[], [name: :pid_cache]], id: :pid_cache),
    ...
    opts = [strategy: :one_for_one, name: JanusPhoenixWebrtcDemo.Supervisor]
  ...
  def config_change(changed, _new, removed) do
    JanusPhoenixWebrtcDemoWeb.Endpoint.config_change(changed, removed)
    :ok
  end
end
